...
NODE_KIT_FILES = (
    ...
    "docker/scripts/tools/node_observation.py",
    "docker/scripts/tools/node_monitor.py",
    "docker/scripts/tools/node_monitor_rules.py",
    "docker/scripts/tools/node_monitor_store.py",
    "docker/scripts/tools/node_resource_metrics.py",
    "docker/scripts/tools/node_resource_history.py",
    "docker/scripts/tools/node_resource_monitor.py",
