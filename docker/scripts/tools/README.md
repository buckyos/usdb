...
| [usdb_node.py](/home/bucky/work/usdb/docker/scripts/tools/usdb_node.py) | Install-time controller for one immutable release node kit | generated private `node.env` | `bitcoin + runtime + frozen network` | resumable readiness-ordered startup | release identity is immutable; node data persists |
