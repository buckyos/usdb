...
| [release_manifest.py](/home/bucky/work/usdb/docker/scripts/tools/release_manifest.py) | release candidate identity | creates or validates the digest-pinned three-repository manifest | after all three GHCR candidates and component CI checks pass | v3 derives snapshot status from the frozen bundle |
