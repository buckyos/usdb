...
| [snapshot_distribution.py](/home/bucky/work/usdb/docker/scripts/tools/snapshot_distribution.py) | immutable snapshot distribution | prepares content-addressed records, uploads through AWS CLI, and resumes verified HTTPS installs | after exact-height finalize or before a node's first `up` | publisher credentials stay in AWS profile/env; nodes use public HTTPS and the bundled trusted-key catalog |
