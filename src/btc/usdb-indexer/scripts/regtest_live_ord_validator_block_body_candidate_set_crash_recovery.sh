...
USDB_INDEXER_RPC_PORT="${USDB_INDEXER_RPC_PORT:-31320}"
...
main() {
  ...
  cat >"$mint_a_file" <<'EOF'
{"p":"usdb","op":"mint","v":1,"usdb_main":"0x1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a","prev":[]}
EOF
  cat >"$mint_b_file" <<'EOF'
{"p":"usdb","op":"mint","v":1,"usdb_main":"0x2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b","prev":[]}
EOF
