...
export MISMATCH_CASE_NAME="active-version-set-mismatch"
export MISMATCH_FIELD="active_version_set_id"
export MISMATCH_VALUE="ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
export MISMATCH_ERROR_CODE="-32056"
export MISMATCH_ERROR_MESSAGE="ACTIVE_VERSION_SET_MISMATCH"
...
export USDB_INDEXER_RPC_PORT="${USDB_INDEXER_RPC_PORT:-31020}"
