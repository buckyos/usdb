...
main() {
  ...
  if [[ "$SIM_VALIDATOR_SAMPLE_ENABLED" == "1" ]]; then
    validator_sample_args+=(
      ...
      --validator-sample-mode "$SIM_VALIDATOR_SAMPLE_MODE"
