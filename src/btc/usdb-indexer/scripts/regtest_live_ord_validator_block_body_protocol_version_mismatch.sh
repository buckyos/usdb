...
MISMATCH_CASE_NAME="${MISMATCH_CASE_NAME:-active-version-set-mismatch}"
MISMATCH_FIELD="${MISMATCH_FIELD:-active_version_set_id}"
MISMATCH_VALUE="${MISMATCH_VALUE:-ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff}"
MISMATCH_ERROR_CODE="${MISMATCH_ERROR_CODE:--32056}"
MISMATCH_ERROR_MESSAGE="${MISMATCH_ERROR_MESSAGE:-ACTIVE_VERSION_SET_MISMATCH}"
...
USDB_INDEXER_RPC_PORT="${USDB_INDEXER_RPC_PORT:-30220}"
ORD_RPC_PORT="${ORD_RPC_PORT:-30230}"
WALLET_NAME="${WALLET_NAME:-usdbvalidatorprotocolmismatch}"
ORD_WALLET_NAME="${ORD_WALLET_NAME:-ord-validator-protocol-mismatch-a}"
ORD_WALLET_NAME_B="${ORD_WALLET_NAME_B:-ord-validator-protocol-mismatch-b}"
