...
USDB_INDEXER_RPC_PORT="${USDB_INDEXER_RPC_PORT:-29020}"
ORD_RPC_PORT="${ORD_RPC_PORT:-29030}"
...
# Keep enough separation for the default stable-lag window so pass2 deterministically
# overtakes pass1 after both passes accrue energy while the top-up becomes stable.
ENERGY_TOP_UP_B_BTC="${ENERGY_TOP_UP_B_BTC:-20.0}"
