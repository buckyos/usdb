...
SIM_STANDARD_MINT_PROBABILITY="${SIM_STANDARD_MINT_PROBABILITY:-0.16}"
...
# Global cross-check diagnostics cadence and sample size.
...
main() {
  ...
  env \
    ...
    SIM_STANDARD_MINT_PROBABILITY="${SIM_STANDARD_MINT_PROBABILITY}" \
    SIM_FIXED_COLLAB_MINT_PROBABILITY="${SIM_FIXED_COLLAB_MINT_PROBABILITY}" \
    SIM_ADDRESS_COLLAB_MINT_PROBABILITY="${SIM_ADDRESS_COLLAB_MINT_PROBABILITY}" \
