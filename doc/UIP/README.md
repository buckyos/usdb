...
- [UIP-0007-ethw-consensus-reward-payload.md](./UIP-0007-ethw-consensus-reward-payload.md)：ETHW `header.Extra` 中的最小 USDB reward consensus payload。
...
- `UIP-0007-ethw-consensus-reward-payload.md`
