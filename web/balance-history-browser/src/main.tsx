...
const dictionaries: Record<Locale, Record<string, string>> = {
  en: {
    ...
    scriptHashPlaceholder: 'Enter BtcScriptHash',
    height: 'Height',
    range: 'Range',
    latest: 'Latest',
    query: 'Query',
    ...
    scriptHashesPlaceholder: 'One BtcScriptHash per line',
    records: 'Records',
  ...
  'zh-CN': {
    ...
    scriptHashPlaceholder: '输入 BtcScriptHash',
    height: 'Height',
    range: 'Range',
    latest: 'Latest',
    query: '查询',
    ...
    scriptHashesPlaceholder: '每行一个 BtcScriptHash',
    records: 'Records',
    latestHeight: 'Latest Height',
    latestBalance: 'Latest Balance',
    netDelta: 'Net Delta',
