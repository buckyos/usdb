...
export function App() {
  return <PrivateConsole><ConsoleApp /></PrivateConsole>
}
  ...
  return (
    ...
    >
      ...
      <Routes>
        ...
        <Route path="/overview" element={<OverviewPage data={error ? undefined : data} locale={locale} t={t} />} />
        <Route path="/apps" element={<AppsPage data={error ? undefined : data} t={t} />} />
        <Route path="/services" element={<Navigate to="/services/btc-node" replace />} />
        <Route
          path="/services/:serviceId"
          element={<ServicesPage data={error ? undefined : data} locale={locale} t={t} />}
        />
